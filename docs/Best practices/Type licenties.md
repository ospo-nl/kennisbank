...
- Bewaken van de integriteit van de auteurs
- Bewaken van digitale rechten.
...
de software kan integreren in andere applicaties of delen hergebruiken in compleet andere situaties. Over het algemeen 
hebben OSS licenties een aantal dingen gemeenschappelijk.
...
De broncode mag naar eigen inzicht worden aangepast waaarbij de aangepaste broncode hoeft niet opnieuw openbaar 
gemaakt te worden. Dit type broncode kan dus vrij gebruikt worden in gesloten software. In geval van de Apache 2.0 
...
softwareoplossing waarbinnen dit type broncode wordt gebruikt 'geïnfecteerd' raakt door deze licentie. Als je dus een 
GPLv3 broncode gebruikt in een groter geheel, dan moet het grotere geheel ook onder de GPLv3 licentie beschikbaar 
gesteld worden.
Vooorbeeld: Software A bestaat uit component A (MIT), B (EUPL) en C (GPLv3). Dan betekent dat dat software A als geheel 
onder de GPLv3 licentie valt. Component A en component B kunnen nog steeds wel onafhankelijk hergebruikt worden onder 
hun oorspronkelijke licentie. Deze licenties zijn dus niet verenigbaar met gesloten software. Bekendste voorbeeld is: 
GPLv3.
...
aangesproken / aangeklaagd wordt door de oorspronkelijke maker voor onjuist gebruik.
...
gewerkt het recht de (die versie van de) broncode ook verder te verspreiden.
